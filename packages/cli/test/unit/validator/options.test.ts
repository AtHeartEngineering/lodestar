...
import {parseFeeRecipient} from "../../../src/cmds/validator/options";
...
describe("invalid feeRecipient", () => {
  const testCases: string[] = [feeRecipientString,`X0${feeRecipientString}`,`0x${feeRecipientString}13`,`0x${feeRecipientString.substr(0,38)}`];
  for (const testCase of testCases) {
